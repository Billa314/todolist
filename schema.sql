-- ==========================================
-- COGNITIVE FLOW - SUPABASE DATABASE SCHEMA
-- ==========================================
-- Run this SQL script in your Supabase SQL Editor to initialize the database tables.
...
-- Create policies (for simplicity on client requests, let's allow all operations)
